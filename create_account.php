  ...
  if (isset($HTTP_POST_VARS['action']) && ($HTTP_POST_VARS['action'] == 'process')) {
    ...
    if (strlen($email_address) < ENTRY_EMAIL_ADDRESS_MIN_LENGTH) {
      ...
      if ($check_email['total'] > 0) {
        ...
        $messageStack->add('create_account', ENTRY_EMAIL_ADDRESS_ERROR_EXISTS . '<br>' . sprintf(TEXT_ORIGIN_LOGIN, tep_href_link(FILENAME_LOGIN, tep_get_all_get_params(), 'SSL')));
      }
    }
...
// build the message content
      ...
      $email_text .= EMAIL_WELCOME . sprintf(EMAIL_TEXT,$email_address,$password) . EMAIL_CONTACT; // . EMAIL_WARNING;
...
//             str_pad( EMAIL_NEW_CLIENT_STATE, 20)   . $state . "\n" . 
	  ...
	  $email_text_owner = 
	    '<table border="0" width="600" id="table1">' .
	      ...
	      '</tr><tr>' .
	        '<td width="80"><b>' . EMAIL_NEW_CLIENT_NAME    . '</b></td><td width="520">' . $firstname . ' ' . $lastname . "</td>" .
		  '</tr><tr>' .
	      ...
	      '</tr><tr>' .
	        '<td width="80"><b>' . EMAIL_NEW_CLIENT_ADDRESS . '</b></td><td width="520">' . $street_address  . "</td>" .
	      '</tr><tr>' .
...
?>
              ...
              <td class="main"><?php echo tep_get_country_list('country',DEFAULT_COUNTRY) . ' ' . (tep_not_null(ENTRY_COUNTRY_TEXT) ? '<span class="inputRequirement">' . ENTRY_COUNTRY_TEXT . '</span>': ''); ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
...
?>
 ...
 <td class="main"><?php echo '<a href="/">' . tep_image_button('button_continue_shopping.gif', IMAGE_BUTTON_CONTINUE_SHOPPING) . '</a>'; ?></td>
