  ...
  if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'process')) {
    ...
    if ($error == false) {
      ...
      $email_body .= sprintf(TEXT_EMAIL_LINK, tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $HTTP_GET_VARS['products_id'], 'NONSSL', false)) . "\n\n" .
                     sprintf(TEXT_EMAIL_SIGNATURE, $from_name . "\n" . HTTP_SERVER . "\n");

      tep_mail($to_name, $to_email_address, $email_subject, $email_body, $from_name, $from_email_address);
       if (SEND_EXTRA_TELL_A_FRIEND_EMAILS_TO != '') {
      // en eentje naar de eigenaaresse
      tep_mail('',SEND_EXTRA_TELL_A_FRIEND_EMAILS_TO, $email_subject, $email_body, $from_name, $from_email_address);
      }
              ...
              <tr class="infoBoxContents">
                <td><table border="0" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td class="main"><?php 
echo tep_draw_input_field('from_name',$from_name); 
?></td>
                  </tr>
                  <tr>
