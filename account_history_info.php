...
<?php
  ...
  for ($i=0, $n=sizeof($order->products); $i<$n; $i++) {
    ...
    echo '            <td class="main" align="right" valign="top" nowrap>' . $currencies->format(tep_add_tax($order->products[$i]['final_price'], $order->products[$i]['tax']) * $order->products[$i]['qty'], true, $order->info['currency'], $order->info['currency_value']) . '</td>' . "\n" .
         '          </tr>' . "\n";
  }
?>
                </table></td>
