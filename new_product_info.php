...
*/
  ...
  $product_check_query = tep_db_query("select count(*) as total,pd.products_name from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd where p.products_status = '1' and p.products_id = '" . (int)$HTTP_GET_VARS['products_id'] . "' and pd.products_id = p.products_id and pd.language_id = '" . (int)$languages_id . "' GROUP BY p.products_id");
  ...
  if (MOPICS_TABLE_LOCATION=='below' && !empty($mopics_output)) {
    echo '&nbsp;<br>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr><td><span class="smallText">Overige afbeeldingen:</span></td></tr>
            <tr>
              <td align="center" class="smallText">'.$mopics_output.'</td>
            </tr>
          </table>'."\n";
