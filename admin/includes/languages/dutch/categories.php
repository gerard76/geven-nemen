...
// ASK - TNT MODULE tntpostf- START
define('TEXT_PRODUCTS_TNT_F_TR', '0=Niet TNT, 1=Brief, 2=Briefboek, 3=Boek, 4=Pakket');

// ASK - TNT MODULE tntpostf- END
...
define('TEXT_DELETE_IMAGE', 'Verwijder plaatje');
...
define('TEXT_PRODUCTS_WEIGHT', 'Gewicht (in hele grammen):');
