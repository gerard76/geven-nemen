...
define('EMAIL_TEXT_SUBJECT', 'Link op Geven & Nemen');
define('EMAIL_TEXT_STATUS_UPDATE', '%s,' . "\n\n" . 'De status van je link bij ' . STORE_NAME . ' is aangepast.' . "\n\n" . 'Niewe status: %s' . "\n\n" . '%s' . "\n\n" . 'Als je vragen hebt kun je op deze mail reageren.' . "\n");
define('EMAIL_TEXT_STATUS_DENIAL_CONTENT', 'The content of the submitted site does not meet our link exchange criteria.');
define('EMAIL_TEXT_URL_LOCATION', 'Je kunt je link terugzien op:' . "\n\n\t" . ' %s');
