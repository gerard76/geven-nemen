...
define('BOX_GUESTBOOK', 'Gastenboek');
define('TEXT_DISPLAY_NUMBER_OF_GUESTBOOK', 'Laat <b>%d</b> tot <b>%d</b> (van <b>%d</b> reacties zien)');

// Add-on - Information Pages Unlimited
define('BOX_HEADING_INFORMATION', 'Pagina\'s');
