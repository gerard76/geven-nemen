...
*/
  ...
  class newsletter {
    ...
    function send($newsletter_id) {
      ...
      $mimemessage = new email(array('X-Mailer: geven & nemen mailer'));
      $mimemessage->add_text($this->content);
      $mimemessage->build_message();
// test van gerard
$mail['customers_firstname'] = 'Mila';
$mail['customers_lastname'] = 'Leijdekkers';
$mail['customers_email_address'] = 'milamaan@hotmail.com';
