...
// ASK - TNT MODULE - START   
   'manufacturers_id' => tep_db_prepare_input($HTTP_POST_VARS['manufacturers_id'
]),'tnt' => tep_db_prepare_input($HTTP_POST_VARS['tnt']));
// ASK - TNT MODULE - STOP
...
// BOF: More Pics 6
      ...
      {
        //add delete image function
        if ($HTTP_POST_VARS['delete_image_'.$subimage] == 'yes') {
          unlink(DIR_FS_CATALOG_IMAGES . 
                 $HTTP_POST_VARS['products_previous_subimage'.$subimage]);
          $sql_data_array['products_subimage'.$subimage] = tep_db_prepare_input($HTTP_POST_VARS['none']);
        }
        //end delete image function 
        if (isset($HTTP_POST_VARS['products_subimage'.$subimage]) && tep_not_null($HTTP_POST_VARS['products_subimage'.$subimage]) && ($HTTP_POST_VARS['products_subimage'.$subimage] != 'none')) {
              $sql_data_array['products_subimage'.$subimage] = tep_db_prepare_input($HTTP_POST_VARS['products_subimage'.$subimage]);
            }
      }
      ...
      case 'copy_to_confirm':
        if (isset($HTTP_POST_VARS['products_id']) && isset($HTTP_POST_VARS['categories_id'])) {
          ...
          // ASK - TNT MODULE - START
            ...
            $product_query = tep_db_query("select products_quantity, products_model, products_image, products_subimage1, products_subimage2, products_subimage3, products_subimage4, products_subimage5, products_price, products_date_available, products_weight, products_tax_class_id, manufacturers_id, tnt from " . TABLE_PRODUCTS . " where products_id = '" . (int)$products_id . "'");
            $product = tep_db_fetch_array($product_query);

            tep_db_query("insert into " . TABLE_PRODUCTS . " (products_quantity,
 products_model,products_image,products_subimage1, products_subimage2, products_subimage3, products_subimage4, products_subimage5, products_price, products_date_added, products_date_available, products_weight, products_status, products_tax_class_id, manufacturers_id, tnt) values ('" . tep_db_input($product['products_quantity']) . "', '" . tep_db_input($product['products_model']) . "', '" . tep_db_input($product['pro ducts_image']) . "', '" . tep_db_input($product['products_subimage1']) . "', '" . tep_db_input($product['products_subimage2']) . "', '" . tep_db_input($product['products_subimage3']) . "', '" . tep_db_input($product['products_subimage4']) . "', '" . tep_db_input($product['products_subimage5']) . "', '" . tep_db_input($product['products_price']) . "',  now(),
 " . (empty($product['products_date_available']) ? "null" : "'" . tep_db_input($product['products_date_available']) . "'") . ", '" . tep_db_input($product['products_weight']) . "', '0', '" . (int)$product['products_tax_class_id'] . "', '" . (int)$product['manufacturers_id'] . "', '" . tep_db_input($product['tnt']) . "')");    
...
// copy subimage only if modified
        for($subimage=1;$subimage<6;$subimage++)
        {
         if(!$HTTP_POST_VARS['delete_image_'.$subimage]=='yes')
         {
           if($_FILES['products_subimage'.$subimage]['name'])
           {
            $products_image = new upload('products_subimage'.$subimage);
            $products_image->set_destination(DIR_FS_CATALOG_IMAGES);
            if ($products_image->parse() && $products_image->save()) {
              $products_subimage_name[$subimage-1] = $products_image->filename;
            }
          }
          else{
              $products_subimage_name[$subimage-1] = (isset($HTTP_POST_VARS['products_previous_subimage'.$subimage]) ? $HTTP_POST_VARS['products_previous_subimage'.$subimage] : '');
           }
         }
        }
        break;
...
// ASK - TNT MODULE - START
    if (isset($HTTP_GET_VARS['pID']) && empty($HTTP_POST_VARS)) {
      $product_query = tep_db_query("select pd.products_name, pd.products_description, pd.products_url, p.products_id, p.products_quantity, p.products_model, p.
products_image, p.products_subimage1,p.products_subimage2, p.products_subimage3, p.products_subimage4, p.products_subimage5, p.products_price, p.products_weight, p.products_date_added, p.products_last_modified, date_format(p.products_date_available, '%Y-%m-%d') as products_date_available, p.products_status, p.products_tax_class_id, p.manufacturers_id, p.tnt from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd 
where p.products_id = '" . (int)$HTTP_GET_VARS['pID'] . "' and p.products_id = pd.products_id and pd.language_id = '" . (int)$languages_id . "'");
      $product = tep_db_fetch_array($product_query);
// ASK - TNT MODULE - STOP
...
<?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . tep_draw_checkbox_field('delete_image', 'yes', false) . TEXT_DELETE_IMAGE; ?></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
          ...
          <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_IMAGE; ?></td>
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '25', '15') . '&nbsp;' . tep_draw_file_field('products_subimage1') . '<br>' . tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . $pInfo->products_subimage1 . tep_draw_hidden_field('products_previous_subimage1', $pInfo->products_subimage1); ?> <?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . tep_draw_checkbox_field('delete_image_1', 'yes', false) . TEXT_DELETE_IMAGE; ?>
</td>
          </tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          ...
          <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_IMAGE; ?></td>
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '25', '15') . '&nbsp;' . tep_draw_file_field('products_subimage2') . '<br>' . tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . $pInfo->products_subimage2 . tep_draw_hidden_field('products_previous_subimage2', $pInfo->products_subimage2); ?> <?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . tep_draw_checkbox_field('delete_image_2', 'yes', false) . TEXT_DELETE_IMAGE; ?>
</td>
          </tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
...
?>
          ...
          <tr>
           ...
           <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_input_field('tnt', $pInfo->tnt); ?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
<?php
    ...
    if (tep_not_null($HTTP_POST_VARS)) {
      ...
      $product_query = tep_db_query("select p.products_id, pd.language_id, pd.products_name, pd.products_description, pd.products_url, p.products_quantity, p.products_model, p.products_image, p.products_subimage1,p.products_subimage2, p.products_subimage3, p.products_subimage4, p.products_subimage5,  p.products_price, p.products_weight, p.products_date_added, p.products_last_modified, p.products_date_available, p.products_status, p.manufacturers_id, p.tnt  from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd where p.products_id = pd.products_id and p.products_id = '" . (int)$HTTP_GET_VARS['pID'] . "'");
      $product = tep_db_fetch_array($product_query);

      $pInfo = new objectInfo($product);
      $products_image_name = $pInfo->products_image;
      $products_subimage_name[0] = $pInfo->products_subimage1;
      $products_subimage_name[1] = $pInfo->products_subimage2;
      $products_subimage_name[2] = $pInfo->products_subimage3;
      $products_subimage_name[3] = $pInfo->products_subimage4;
      $products_subimage_name[4] = $pInfo->products_subimage5;
    }
...
?>
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      <?php 
      if(tep_not_null($products_image_name)) {
      ?>
      <tr>
   ...
   <table>
    <tr>
<?php
    if (tep_not_null($products_subimage_name[0])) {
?>  
    <td class="main"><?php echo tep_image(DIR_WS_CATALOG_IMAGES . $products_subimage_name[0], $pInfo->products_subimage1, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="right" hspace="5" vspace="5"') ?></td>
  <?php } ?>
<?php
    if (tep_not_null($products_subimage_name[1])) {
?>    
    <td class="main"><?php echo tep_image(DIR_WS_CATALOG_IMAGES . $products_subimage_name[1], $pInfo->products_subimage2, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="right" hspace="5" vspace="5"') ?></td>
  <?php } ?>
<?php
    if (tep_not_null($products_subimage_name[2])) {
?>
    <td class="main"><?php echo tep_image(DIR_WS_CATALOG_IMAGES . $products_subimage_name[2], $pInfo->products_subimage3, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="right" hspace="5" vspace="5"') ?></td>
  <?php } ?>
...
<?php
    if (tep_not_null($products_subimage_name[3])) {
?>
        <td class="main"><?php echo tep_image(DIR_WS_CATALOG_IMAGES . $products_subimage_name[3], $pInfo->products_subimage4, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="right" hspace="5" vspace="5"') ?></td>
    <?php } ?>
<?php
    if (tep_not_null($products_subimage_name[4])) {
?>
    <td class="main"><?php echo tep_image(DIR_WS_CATALOG_IMAGES . $products_subimage_name[4], $pInfo->products_subimage5, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="right" hspace="5" vspace="5"') ?></td>
  <?php } ?>
</tr>
<?php
...
/* Re-Post all POST'ed variables */
      ...
      for($si=0;$si<5;$si++)
       echo tep_draw_hidden_field('products_subimage'.($si+1), stripslashes($products_subimage_name[$si]));
...
<?php
    ...
    $products_count = 0;
    if (isset($HTTP_GET_VARS['search'])) {
      $products_query = tep_db_query("select p.products_id, pd.products_name, p.products_quantity, p.products_image, p.products_subimage1, p.products_subimage2, p.products_subimage3, p.products_subimage4, p.products_subimage5, p.products_price, p.products_date_added, p.products_last_modified, p.products_date_available, p.products_status, p2c.categories_id, p.tnt from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c where p.products_id = pd.products_id and pd.language_id = '" . (int)$languages_id . "' and p.products_id = p2c.products_id and pd.products_name like '%" . tep_db_input($search) . "%' order by pd.products_name");
    } else {
      $products_query = tep_db_query("select p.products_id, pd.products_name, p.products_quantity, p.products_image, p.products_subimage1, p.products_subimage2, p.products_subimage3, p.products_subimage4, p.products_subimage5, p.products_price, p.products_date_added, p.products_last_modified, p.products_date_available, p.products_status, p.tnt from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c where p.products_id = pd.products_id and pd.language_id = '" . (int)$languages_id . "' and p.products_id = p2c.products_id and p2c.categories_id = '" . (int)$current_category_id . "' order by pd.products_name");
    }
