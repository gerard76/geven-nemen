...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td class="pageHeading" width=90% valign="top"><?php echo tep_image(DIR_WS_CATALOG_IMAGES . 'logo.gif', STORE_NAME); ?></td>
        <td class="main" nowrap><strong><?php echo nl2br(STORE_NAME_ADDRESS); ?></strong></td>
      </tr>
    </table></td>
  </tr>
  <tr>
