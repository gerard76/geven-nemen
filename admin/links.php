  ...
  if (tep_not_null($action)) {  
    switch ($action) {
      ...
      case 'update':
        ...
        $links_reciprocal_check_count = tep_db_prepare_input($_POST['links_reciprocal_check_count']);
...
?></td>
          ...
          <tr>
            ...
            <td><?php  echo tep_draw_checkbox_field('links_reciprocal_disable', '', $lInfo->links_reciprocal_disable); ?></td>
          </tr>     
          <tr>
            <td class="main"><?php echo ENTRY_LINKS_RECIPROCAL_CHECK_COUNT; ?></td>
            <td><?php  echo tep_draw_input_field('links_reciprocal_check_count', $lInfo->links_reciprocal_check_count, 'size="4" maxlength="4"'); ?></td>
          </tr>               
        </table></td>
      </tr>
<?php } ?>      
...
<?php 
  ...
  if ($action == 'edit' || $action == 'update') {
    ...
    echo tep_draw_checkbox_field('links_notify', '','0');
            ...
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                <td class="dataTableHeadingContent" align="center">
                  ...
                  <a href="<?php echo "$PHP_SELF?listing=titlecat"; ?>"><?php echo ($listing=='titlecat' ? '<font color="FF0000"><b>Asc</b></font>' : '<b>Asc</b>'); ?></a>&nbsp;
                  <a href="<?php echo "$PHP_SELF?listing=titlecat-desc"; ?>"><?php echo ($listing=='titlecat-desc' ? '<font color="FF0000"><b>Desc</b></font>' : '<b>Desc</b>'); ?></a>
                </td>              
                <td class="dataTableHeadingContent" align="center">
...
?>
                  ...
                  <tr>
                   ...
                   <td align="right"><?php echo (tep_image_submit('button_check_links.gif', 'Check Links') ); ?></td>
