  ...
  <tr class="infoBoxContents">
   <td><table border="0" width="100%" cellspacing="2" cellpadding="2">
    <tr>
     ...
     <td class="main">' . LINK_NAME . '</td>
    </tr> 
    <tr>
     <td class="main">Link Description:</td>
     <td class="main">' . LINK_DESCRIPTION . '</td>
    </tr> 
    <tr>
     <td class="main">Link URL:</td>
     <td class="main">' . LINK_URL . '</td>
    </tr>  
   </table></td>
  </tr> 
 </table></td>
      ...
      <td width="50%"><table border="0" width="100%" style="border-collapse: collapse;">
       <tr>
           <td><table border="0" width="100%" style="border-collapse: collapse;">
            <tr>
             <td style="font-family: Verdana, Arial, sans-serif; font-size: 11px;"><b><a href="' . LINK_URL . '" target="_blank" title="' . LINK_NAME . '">' . LINK_NAME . '</a></b></td>
            </tr> 
            <tr><td height="10"></td><tr>
            <tr>
             <td style="font-family: Verdana, Arial, sans-serif; font-size: 11px;">' . LINK_DESCRIPTION . '</td>
            </tr> 
            <tr><td height="10"></td><tr>
            <tr>
             <td style="font-family: Verdana, Arial, sans-serif; font-size: 11px;"><a href="' . LINK_URL . '" target="_blank" title="' . LINK_NAME . '">' . LINK_URL . '</a></td>
            </tr>  
           </table></td>
          </tr>  
      </table></td>
