...
/*
  ...
  Felix Scheiffers, NL - Oct. 2007 - TNT MODULE 'tntpostf.php' support added 
*/

  class shoppingCart {
    var $contents, $total, $weight, $cartID, $content_type;
    // FS - TNT MODULE 'tntpostf.php' - START
    var $tnt, $tnt_f_tr_0, $tnt_f_tr_1, $tnt_f_tr_2, $tnt_f_tr_3, $tnt_f_tr_4, $tnt_f_total_ex_tax;
...
// products price
        ...
        $product_query = tep_db_query("select products_id, products_price, products_tax_class_id, products_weight, tnt from " . TABLE_PRODUCTS . " where products_id = '" . (int)$products_id . "'");
        // FS - TNT MODULE 'tntpostf.php' - STOP		
        ...
        if ($product = tep_db_fetch_array($product_query)) {
          ...
          // FS - TNT MODULE 'tntpostf.php' - START
          $products_tnt_f_tr = (int)$product['tnt'];
     	  // FS - TNT MODULE 'tntpostf.php' - STOP          
