      ...
      for ($col=0, $n=sizeof($column_list); $col<$n; $col++) {
          switch ($column_list[$col]) {
            case 'LINK_LIST_TITLE':
              if (LINKS_TITLES_AS_LINKS !:w
= 'True')
                echo '<tr><td height="10">&nbsp;</td></tr><tr><td class="linkListingMain"><b>',$listing['links_title'].'</b></td></tr>';
              else
                echo '<tr><td height="10">&nbsp;</td></tr><tr><td class="linkListingMain"><b><a class="linkListingMain" href="' . tep_get_links_url($listing['links_id']) . '" target="_blank">' . $listing['links_title'] . '</a></b></td></tr>';
              break;
            case 'LINK_LIST_URL':
              echo '<tr><td class="linkListingMain"><a class="linkListingMain" href="' . tep_get_links_url($listing['links_id']) . '" target="_blank">' . $listing['links_url'] . '</a></td></tr>';
              break;
