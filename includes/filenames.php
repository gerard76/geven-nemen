...
// define the filenames used in the project
  ...
  define('FILENAME_CONTACT_US', 'opmerkingen.php');
  ...
  define('FILENAME_IDEALMOLLIEM','idealmolliem.php');
  define('FILENAME_GUESTBOOK', 'book.php');
  define('FILENAME_GUESTBOOK_SIGN', 'book_sign.php');
...
// Links Manager II v1.18 end
  ...
  define('FILENAME_INFORMATION', 'pages.php');
?>
