...
*/
  ...
  function tep_show_category($counter) {
    ...
    if (isset($cPath_array) && in_array($counter, $cPath_array)) {
      $categories_string .= '<b class=categoryActive>';
    }
...
<?php
 ...
 $info_box_contents[] = array('text' => tep_image(DIR_WS_IMAGES . 'infobox_category_title.gif',BOX_HEADING_CATEGORIES));
